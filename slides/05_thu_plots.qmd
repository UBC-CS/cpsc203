...
- First imagine what the path of *one* song looks like.
...
``` {pyodide}
# Full year: 52 weeks × 100 songs = 5200 rows
print(f"Shape: {df.shape}")
print(f"Weeks of data: {df['date'].nunique()}")
df.head()
```

## Structure of Multi-Week Data {.smaller}
...
## `.isin()` — Filter by List Membership {.smaller}
