...
1.  The time it takes to solve a problem can be parameterized by the size of the problem.
    In many cases we can use a simple mathematical function to describe that time.
