...
1. POTW will be open indefinitely
2. EX2 this week
...
1. Metaphors for software design. 
2. Efficiency -- how long do bits of code take to run?
3. Representation -- binary numbers, colors
4. Sums (a bit of an aside)
5. Lists & Dictionaries (intro)
7. Data Classes
8. Handcraft/Garden -- putting it together into something bigger
