...
![](/images/name-bracelet.svg){.r-stretch fig-alt="A bracelet with letter beads spelling CPSC203."}
...
def name(self, word: str) -> None:
    """Assign letters from word to the first beads."""
...
# Check the letters
print(bracelet.beads[0].letter)  # "H"
print(bracelet.beads[1].letter)  # "I"
