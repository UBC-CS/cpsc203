...
Find an online image you would like to boost and use its URL in the code we just wrote.

How can you adjust the code to manipulate the colours in a different way?
