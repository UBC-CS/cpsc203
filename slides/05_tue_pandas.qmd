...
## Last time: Lists of Dictionaries

We explored Billboard data using **loops**:

``` {pyodide}
chartlist = [
    {"title": "Die With A Smile", "artist": "Lady Gaga & Bruno Mars", "rank": 1},
    {"title": "APT.", "artist": "Rose & Bruno Mars", "rank": 2},
    {"title": "Shake It Off", "artist": "Lady Gaga", "rank": 10},
]
...
- Rows = records (songs)
- Columns = attributes (title, artist, rank, ...)
...
CSV files have field names in row 1, and data beginning in row 2.
...
# Add a "gradient" column (positive = rising)
