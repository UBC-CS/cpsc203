...
## {{< iconify fa6-solid comments >}} Your turn: Binary to decimal {.activity}
...
Can we represent any integer this way? YES! Until we run out of memory. But we have more memory than we can even conceive of.
:::
