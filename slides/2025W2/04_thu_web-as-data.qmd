...
## How does the internet work? {.activity}

1. Make a sketch representing the internet. 

\ 

\ 

2. Use the sketch to describe what happens when you load your favourite web page. 
...
What happens to the URL if you load a past week?
...
Usually a collection of functions you can call from code to allow you to access data contained in
a web page. 
...
## Billboard Hot 100 Demo {.activity}

\

[Link to PL activity](https://us.prairielearn.com/pl/course_instance/202804/assessment/2641271)

The activity contains several challenges!
...
* Web data can be accessed programmatically using **APIs**
* The `billboard.py` library gives us chart data as Python objects
* We converted that data into a **list of dictionaries**
* We answered questions using loops and list comprehensions

## The challenge

Every question required writing a loop:

* Find the #1 song → loop through list
* Count new songs → loop and count
* Find the longest-running song → loop and track max
* Calculate average peak → loop and sum

What if there was a data structure *designed* for this kind of analysis?

## Next time

Introducing **DataFrames** — a powerful data structure that makes
tabular data analysis much simpler:

* Filtering data in one line
* Built-in aggregations (mean, max, count...)
