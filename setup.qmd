---
title: "Setup: Tech stack OLD DO NOT USE"
---
...
If you have previously installed Python and any related packages, we **strongly** recommend uninstalling them.
Be sure to remove any user configuration files and back them up if desired.
...
{{< include /includes/software/_vs-code.qmd >}}
...
{{< include /includes/software/_tree.qmd >}}
