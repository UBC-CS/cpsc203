...
Now wrap it with 3 more squares (the next odd number):
...
That's why $1 + 3 + 5 + \ldots + 1337 = 669^2 = 447561$. (There are 669 odd numbers from 1 to 1337.)
...
The sum of the first $k$ even numbers follows a similar pattern. Notice that:

$$2 + 4 + 6 + \ldots + 2k = 2(1 + 2 + 3 + \ldots + k)$$

But here's another way to see it geometrically. Each even number is just one more than the corresponding odd number:
...
So the sum of the first $k$ evens = sum of the first $k$ odds + $k$:
