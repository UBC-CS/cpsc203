...
schedule <- read_csv(
  ...
  mutate(
    ...
    examlet_display = case_when(
      ...
      !is.na(exam_practice) & str_starts(exam_practice, "http") ~ glue("[{fa('pen-to-square')}]({exam_practice})"),
      # Practice material placeholder (no URL yet) - show faded icon
      !is.na(exam_practice) ~ as.character(fa("pen-to-square", fill_opacity = 0.1)),
