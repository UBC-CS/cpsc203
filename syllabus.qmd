...
|----------------------|-----------------|-------------------|
| Problems of the Week (POTWs) | 10% (10 x 1%)   | Sundays at 8:00 PM   |
| Labs                 | 5% (10 x 0.5%)  | Sundays at 8:00 PM   |
| Programming Projects | 9% (3 x 3%)     | Three weeks long, Mondays at 8:00 PM |
| Examlets             | 50% (5 x 10%)   | Roughly biweekly, self-scheduled Thursday through Monday      |
| Final Exam           | 26%             | Self-scheduled during five day window TBA               |

Students must satisfy **all** of the following conditions to pass the course:

* Achieve a grade of at least 50% on the lab component.
* Achieve a grade of at least 50% on the examlet and final exam components together.
* Achieve a grade of at least 40% on the final exam.

If a student does not satisfy all conditions, they will be assigned the **lower** of 45% or their earned final grade as their course grade.

Students who have not submitted at least half of the lab, POTWs and examlet assessments prior to the final exam may be refused permission to write the final exam.
...
* GenAI is **permitted with attribution** when working on the other graded assessments (POTWs, labs and projects).  If you use GenAI in the process of producing your submission materials, then **you must specify in your submission what tool you used and what prompts you gave it.**  (If there is no specific place to enter your attribution in the PrairieLearn assessment, then put it in a code comment at the top of your file.)  As with your ungraded activities, if you use GenAI then we encourage you to use it in ways that strengthen your learning rather than replace it.
